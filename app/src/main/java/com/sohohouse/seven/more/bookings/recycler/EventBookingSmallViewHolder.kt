...
class EventBookingSmallViewHolder(
    private val binding: ListViewEventCardSmallBinding,
    ...
    fun bind(
        ...
        binding.eventLocationName.text = item.houseName
        binding.root.clicks { onItemClicked(item) }
